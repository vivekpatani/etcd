...
var toGRPCErrorMap = map[error]error{
	...
	namespacequota.ErrNamespaceQuotaNotFound: rpctypes.ErrNamespaceQuotaNotFound,
	namespacequota.ErrNamespaceQuotaRestoreFailed: rpctypes.ErrNamespaceQuotaRestoreFailed,
