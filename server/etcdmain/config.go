...
func newConfig() *config {
	...
	fs.IntVar(&cfg.ec.NamespaceQuotaEnforcement, "experimental-namespace-quota-enforcement", cfg.ec.NamespaceQuotaEnforcement, "Duration of periodic watch progress notifications.")
