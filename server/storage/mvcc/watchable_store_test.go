...
func TestWatch(t *testing.T) {
	...
	s := newWatchableStore(zap.NewExample(), b, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
...
func TestCancelUnsynced(t *testing.T) {
	...
	s := &watchableStore{
		store:    NewStore(zap.NewExample(), b, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{}),
...
func TestWatchRestore(t *testing.T) {
	test := func(delay time.Duration) func(t *testing.T) {
		return func(t *testing.T) {
			...
			newStore := newWatchableStore(zap.NewExample(), newBackend, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
...
func TestWatchRestoreSyncedWatcher(t *testing.T) {
	...
	s1 := newWatchableStore(zap.NewExample(), b1, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
	defer cleanup(s1, b1, b1Path)

	b2, b2Path := betesting.NewDefaultTmpBackend(t)
	s2 := newWatchableStore(zap.NewExample(), b2, &lease.FakeLessor{}, &namespacequota.FakeNamespaceQuotaManager{}, StoreConfig{})
