...
func TestV3NamespaceQuotaSet(t *testing.T) {
	...
	clus := integration.NewClusterV3(t, &integration.ClusterConfig{Size: 3, NamespaceQuotaEnforcement: 2})
...
func TestV3NamespaceQuotaEnforcementSoftMode(t *testing.T) {
	...
	clus := integration.NewClusterV3(t, &integration.ClusterConfig{Size: 3, NamespaceQuotaEnforcement: 1})
	defer clus.Terminate(t)
